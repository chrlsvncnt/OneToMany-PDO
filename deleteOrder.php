...
<body>
	...
	<div class="container" style="border-style: solid; height: 320px;">
		...
		<h2>Shipment Method: <?php echo $getShipmentByID['Category'] ?></h2>
		<h2>Delivery Address: <?php echo $getShipmentByID['Price'] ?></h2>
		<h2>Estimated Delivery Date: <?php echo $getShipmentByID['StockQuantity'] ?></h2>
		<h2>RicePrice: <?php echo $getShipmentByID['Supplier'] ?></h2>
